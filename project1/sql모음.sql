...
COMMENT ON COLUMN "MEMBER"."MEMBER_EMAIL" IS '이메일(아이디로 사용)';
...
COMMENT ON COLUMN "MEMBER"."PROFILE_ING" IS '프로필 이미지 경로';
...
-- 좋아요 수 증가
INSERT INTO "BOARD_LIKE" VALUES(1994, 10);
-- 좋아요 수 감소
...
-- 회원 샘플데이터 삽입
INSERT INTO "MEMBER" VALUES (SEQ_MEMBER_NO.NEXTVAL, 'user01@kh.or.kr', 'pass01!', '유저일', '01012341234', '04540,, 서울시 중구 남대문로 120,, 2층' ,DEFAULT, DEFAULT, DEFAULT, DEFAULT);

INSERT INTO "MEMBER" VALUES (SEQ_MEMBER_NO.NEXTVAL, 'user02@kh.or.kr', 'pass02!', '유저이', '01045674567', '04540,, 서울시 중구 남대문로 120,, 3층' ,DEFAULT, DEFAULT, DEFAULT, DEFAULT);
...
ALTER TABLE "MEMBER"
RENAME COLUMN PROFILE_ING TO PROFILE_IMG;
...
MEMBER_NICKNAME  = '악',
MEMBER_TEL = '웩',
MEMBER_ADDRESS = '123',,'막',,'우'
WHERE MEMBER_NO = ? --> 로그인한 회원의 번호

UPDATE "MEMBER" SET
MEMBER_PW = '$2a$10$YCgHXdefYrf9iTWPHCFCtOUFQBjt4A2VB3Xeiv4IGM.x4IlHYgG2y';
...
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
	'20221116105843_00001.gif', '1.gif', 0, 2001);
...
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
	'20221116105843_00004.gif', '4.gif', 0, 1994);

-- BOARD_LIKE 테이블 샘플데이터 삽입
SELECT * FROM BOARD_LIKE;

INSERT INTO BOARD_LIKE VALUES(2001, 10);
INSERT INTO BOARD_LIKE VALUES(1999, 10);
COMMIT;
...
-- 특정 게시글 상세 조회
SELECT BOARD_NO, BOARD_TITLE, BOARD_CONTENT, READ_COUNT, TO_CHAR(B_CREATE_DATE, 'YYYY"년 " MM"월 " DD"일 " HH24:MI:SS')B_CREATE_DATE, -- 2022년 11월 18일 11:33:12
TO_CHAR(B_UPDATE_DATE, 'YYYY"년 " MM"월 " DD"일 " HH24:MI:SS')B_UPDATE_DATE, -- 2022년 11월 18일 11:33:12
...
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
'20221116105843_00002.gif', '2.gif', 1 , 2001);
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
'20221116105843_00003.gif', '3.gif', 2 , 2001);
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
'20221116105843_00004.gif', '4.gif', 3 , 2001);
...
INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '부모 댓글2', DEFAULT, DEFAULT, 1998, 9, null);
INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '대댓글1', DEFAULT, DEFAULT, 1998, 3, 2699);
INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '대댓글2', DEFAULT, DEFAULT, 1998, 5, 2700);
INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '대댓글3', DEFAULT, DEFAULT, 1998, 10, 2699);

INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '대댓글4', DEFAULT, DEFAULT, 1998, 9, 2699);
INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '대댓글5', DEFAULT, DEFAULT, 1998, 9, 2700);
COMMIT;
...
INSERT INTO "BOARD" BOARD_LIKE (+1);

-- 게시글 삭제여부 조회
SELECT BOARD_NO, BOARD_DEL_FL
FROM BOARD
WHERE BOARD_NO = 1978;
...
ROLLBACK;
  ...
  SELECT NVL(SUM(CHATTING_NO),0) CHATTING_NO FROM CHATTING_ROOM
      WHERE (OPEN_MEMBER = 9 AND PARTICIPANT = 10)
      OR (OPEN_MEMBER = 10 AND PARTICIPANT = 9);
